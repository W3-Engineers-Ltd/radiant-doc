...
See [Test.md](https://radiant.vip/docs/mvc/model/test.md) for more information on database connection strings.
...
You may want Radiant to automatically create your database tables.
...
```
After the initial "radical run" command, change the values of force and verbose to false. 
The default behavior for Radiant is to add additional columns when the model is updated.
